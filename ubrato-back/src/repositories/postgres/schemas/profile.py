...
from src.repositories.postgres.schemas.base import Base
...
class CustomerLocation(Base):
    ...
    org = relationship("Organization", back_populates="customer_locations", lazy="selectin")
    city = relationship("City", back_populates="customer_locations", lazy="selectin")
...
class ContractorService(Base):
    ...
    service_type = relationship("ServiceType", back_populates="contractor_services", lazy="selectin")
...
class ContractorLocation(Base):
    ...
    org = relationship("Organization", back_populates="contractor_locations", lazy="selectin")
    city = relationship("City", back_populates="contractor_locations", lazy="selectin")
