...
from src.repositories.typesense.schemas import TypesenseTender
...
class Tender(Base):
    ...
    tender_service_type = relationship("TenderServiceType", back_populates="tender")
    tender_object_type = relationship("TenderObjectType", back_populates="tender")
