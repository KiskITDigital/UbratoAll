...
class ServiceType(Base):
    ...
    service_group_id: Mapped[int] = mapped_column(Integer, ForeignKey("services_groups.id"))

    service_group = relationship("ServiceGroup", back_populates="service_type")
    tender_service_type = relationship("TenderServiceType", back_populates="tender_service_type")
    draft_service_group = relationship("DraftTenderServiceType", back_populates="service_type")
    contractor_services = relationship("ContractorService", back_populates="service_type")
